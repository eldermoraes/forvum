...
/**
 * {@code MessageProcessor.render} maps each {@code AgentEvent} to the text the Discord user receives.
 ...
 * Exhaustive over the sealed {@code AgentEvent}, byte-identical to the Telegram/web render tests.
 */
class DiscordRenderTest {
