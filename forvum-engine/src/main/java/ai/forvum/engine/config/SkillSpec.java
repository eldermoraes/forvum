 ...
 * {@code OutputSchemaValidator} enforces) that the engine-resident {@code SkillToolProvider}
 * ({@code skill.invoke}, #191) validates invocation arguments against. Produced by {@link SkillReader#parse}.
 */
